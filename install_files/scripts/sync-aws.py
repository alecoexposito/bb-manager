...
# os.system("cd /home/zurikato/apps/tvz-media-server/media; for f in $(/usr/bin/find $PWD -regex '.*\.\(mkv\|webm\|avi\|mp4\)$'); do /usr/bin/ffmpeg -n -i $f -ss 00:00:03 -vframes 1 -s 480x320 ${f%/*}/thumb-${f##*/}.jpg; done")
